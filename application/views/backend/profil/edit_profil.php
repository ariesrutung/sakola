                        ...
                        <div class="col-sm-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="kategori" name="kategori" required>
                                    ...
                                    <option value="sambutan" <?= ($profil['kategori'] == 'sambutan') ? 'selected' : ''; ?>>Sambutan Kepala Sekolah</option>
                                    <option value="visi" <?= ($profil['kategori'] == 'visi') ? 'selected' : ''; ?>>Visi Sekolah</option>
                                    <option value="misi" <?= ($profil['kategori'] == 'misi') ? 'selected' : ''; ?>>Misi Sekolah</option>
                                    <option value="budaya" <?= ($profil['kategori'] == 'budaya') ? 'selected' : ''; ?>>Budaya Sekolah</option>
                                </select>
