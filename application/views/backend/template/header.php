...
<body class="g-sidenav-show bg-gray-100">
    ...
    <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
        ...
        <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link <?php echo ($this->uri->segment(2) == 'dashboard') ? 'active bg-light' : ''; ?>" href="<?= base_url('admin/dashboard') ?>">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#manajemenSurat" class="nav-link <?php echo ($this->uri->segment(3) == 'pengajuan' || $this->uri->segment(3) == 'surat_masuk' || $this->uri->segment(3) == 'editSuratMasuk' || $this->uri->segment(3) == 'tambah_surat_masuk' || $this->uri->segment(3) == 'surat_keluar' || $this->uri->segment(3) == 'editSuratKeluar' || $this->uri->segment(3) == 'tambah_surat_keluar' || $this->uri->segment(3) == 'surat_keterangan' || $this->uri->segment(3) == 'editSuratKeterangan' || $this->uri->segment(3) == 'tambah_surat_keterangan') ? 'active bg-light' : ''; ?>" aria-controls="manajemenSurat" role="button" aria-expanded="false">
                    ...
                    <div class="collapse <?php echo ($this->uri->segment(3) == 'pengajuan' || $this->uri->segment(3) == 'surat_masuk' || $this->uri->segment(3) == 'editSuratMasuk' || $this->uri->segment(3) == 'tambah_surat_masuk' || $this->uri->segment(3) == 'surat_keluar' || $this->uri->segment(3) == 'editSuratKeluar' || $this->uri->segment(3) == 'tambah_surat_keluar' || $this->uri->segment(3) == 'surat_keterangan' || $this->uri->segment(3) == 'editSuratKeterangan' || $this->uri->segment(3) == 'tambah_surat_keterangan') ? 'show' : ''; ?>" id="manajemenSurat">
                        <ul class="nav ms-4">
                            <li class="nav-item ">
                                <a class="nav-link <?php echo ($this->uri->segment(3) == 'pengajuan') ? 'active' : ''; ?>" href="<?= base_url('admin/surat/pengajuan') ?>">
                                    <span class="sidenav-mini-icon"> K </span>
                                    <span class="sidenav-normal"> Pengajuan Surat </span>
                                </a>
                            </li>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link <?php echo ($this->uri->segment(3) == 'surat_masuk' || $this->uri->segment(3) == 'editSuratMasuk' || $this->uri->segment(3) == 'tambah_surat_masuk') ? 'active' : ''; ?>" href="<?= base_url('admin/surat/surat_masuk') ?>">
                                    <span class="sidenav-mini-icon"> K </span>
                                    <span class="sidenav-normal"> Surat Masuk </span>
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link <?php echo ($this->uri->segment(3) == 'surat_keluar' || $this->uri->segment(3) == 'editSuratKeluar' || $this->uri->segment(3) == 'tambah_surat_keluar') ? 'active' : ''; ?>" href="<?= base_url('admin/surat/surat_keluar') ?>">
                                    <span class="sidenav-mini-icon"> K </span>
                                    <span class="sidenav-normal"> Surat Keluar</span>
                                </a>
                            </li>
                            <li class="nav-item ">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#manajemenUsers" class="nav-link <?php echo ($this->uri->segment(2) == 'penduduk' || $this->uri->segment(2) == 'pegawai' || $this->uri->segment(2) == 'user') ? 'active bg-light' : ''; ?>" aria-controls="manajemenUsers" role="button" aria-expanded="false">
                        <div class="icon icon-shape icon-sm text-center d-flex align-items-center justify-content-center">
                            <i class="ni ni-single-02 text-info text-sm opacity-10"></i>
                        </div>
                        <span class="nav-link-text ms-1">Manajemen Users</span>
                    </a>
                    <div class="collapse <?php echo ($this->uri->segment(2) == 'penduduk' || $this->uri->segment(2) == 'pegawai' || $this->uri->segment(2) == 'user') ? 'show' : ''; ?>" id="manajemenUsers">
                        <ul class="nav ms-4">
                            <li class="nav-item">
                    ...
                    <ul class="navbar-nav  justify-content-end">
                        ...
                        <?php if ($this->session->userdata('id_user') == TRUE) : ?>
                            ...
                            <li class="d-flex align-items-center">
                                <a class="text-white btn btn-warning" href="<?= base_url() ?>admin/logout">
